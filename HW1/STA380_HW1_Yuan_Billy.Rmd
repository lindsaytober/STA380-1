...
To start, I will list all abbreviations that will be used in the solution.
...
Let's take a look at how the data is currently distributed. The plot below shots the distribution of leasing rates for both Class A and non-Class A buildings. 
...
For the simulation, a trading period of 10 days will be simulated 3000 times. The portfolios are allocated as follows:
...
ggplot(mapping=aes(n.tweets.cat[,1],n.tweets.cat[,2]),main="Test") + geom_point(stat="identity") + coord_flip()
```
